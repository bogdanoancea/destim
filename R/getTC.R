#'@title Gets the column of the transition matrix.
#'
#'@description Gets the column of the transition matrix corresponding to
#' a point from a rectangular grid according to the mask
#'
#' @param  point We are setting the transition probabilities
#' starting from this point. It corresponds to the column
#' (point[2] - 1 ) * size[1] + point[1] of the transition matrix.
#'
#' @param size Size of the grid. It is expected to be a 2 dimensional
#' vector, containing the number of rows and columns respectively.
#'
#' @param mask Transition probabilities to the contiguous tiles. It
